package com.guldanaev1.presentation.repositories
...
class ContactDataSourceImpl (private val context: Context) : ContactDataSource {
    ...
    override fun getContactList(query: String): List<ContactModel> {
    ...
    override fun getContactDetails(id: String): ContactModel? {
